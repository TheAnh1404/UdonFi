...
VITE_XLM_ASSET_CONTRACT_ID=${XLM_ASSET_CONTRACT_ID:-CDLZFC3SYJYDZT7K67VZ75HPJVIEUVNIXF47ZG2FB2RMQQVU2HHGCYSC}
VITE_USDC_ASSET_CONTRACT_ID=${USDC_ASSET_CONTRACT_ID:-CBIELTK6YBZJU5UP2WWQEUCYKLPU6AUNZ2BQ4WWFEIE3USCIHMXQDAMA}
